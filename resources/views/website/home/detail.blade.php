          ...
          <div class="portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="{{ asset('/') }}website/{{ asset('/') }}website/assets/img/portfolio/portfolio-details-1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="{{ asset('/') }}website/{{ asset('/') }}website/assets/img/portfolio/portfolio-details-2.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="{{ asset('/') }}website/{{ asset('/') }}website/assets/img/portfolio/portfolio-details-3.jpg" alt="">
              </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
            <img src="{{ asset('/') }}website/assets/img/Untitled-1.jpg" alt="" height="60" width="80">
          ...
          <nav id="navbar" class="navbar">
            <ul>
			  ...
			  -->
              <li><a class="nav-link scrollto " href="{{ route('home') }}#portfolio">Services</a></li>
			  	
              <li><a class="nav-link scrollto" href="{{ route('home') }}#team">Pricing</a></li>
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{ asset('/') }}website/assets/img/portfolio/portfolio-details-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{ asset('/') }}website/assets/img/portfolio/portfolio-details-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{ asset('/') }}website/assets/img/portfolio/portfolio-details-3.jpg" alt="">
                </div>
